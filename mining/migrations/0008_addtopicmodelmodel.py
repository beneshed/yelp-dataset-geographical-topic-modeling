...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TopicModels'
        db.create_table(u'mining_topicmodels', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mining.GeoRegion'])),
            ('topic', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'mining', ['TopicModels'])


    def backwards(self, orm):
        # Deleting model 'TopicModels'
        db.delete_table(u'mining_topicmodels')
    ...
    models = {
        ...
        u'mining.topicmodels': {
            'Meta': {'object_name': 'TopicModels'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mining.GeoRegion']"}),
