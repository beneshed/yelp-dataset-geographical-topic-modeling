...
class Migration(DataMigration):
	...
	from django.core.management import call_command
        call_command("loaddata", "active_restaurant_reviews3.json")
	call_command("loaddata", "active_restaurant_reviews4.json")
	call_command("loaddata", "active_restaurant_reviews5.json")
